...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker) {
		if(this.getMagnitude()<((EarthquakeMarker)marker).getMagnitude())
		{
			return -1;
		}
	...
	public void showTitle(PGraphics pg, float x, float y )
	{
		...
		pg.tint(255,126);
		pg.fill(220,220,220);
		pg.ellipse(x, y, (float)threatCircle()/59*EarthquakeCityMap.getZoomLevel(), (float)threatCircle()/59*EarthquakeCityMap.getZoomLevel());
		pg.popStyle();
		pg.pushStyle();
